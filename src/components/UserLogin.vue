  ...
  <body>
    ...
    <div class="user">
      <div class="content-title">
        ...
        <!-- <div> -->
        <!-- <h3>Happiness is the highest form of Health </h3> -->
      ...
      <div class="create">
        <div class="user-login">
          ...
          <button class="create-Account" @click="login">Login as Doctor</button>
        </div>
        <router-link :to="{ name: 'DoctorSignup' }">
          <p>
            <u><b>Create a Doctor Profile </b></u>
          </p>
        </router-link>
      </div>
...
export default {
  ...
  methods: {
    userLogin() {
      firebase
        .auth()
        .signInWithEmailAndPassword(this.posts.email, this.posts.password)
        .then(() => {
          this.errors = [];
          if (!this.posts.email) {
            ...
            this.errors.push("Please enter your password");
              ...
              "userEmail",
              JSON.stringify(this.posts.email)
            )
    ...
    postData() {
      ...
      // this.axios.get(`http://10.20.2.211:8082/user/validation/${this.posts.email}/${this.posts.password}`, this.posts)
      //     .then((Response) => {
